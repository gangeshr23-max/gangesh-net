  ...
  return (
    <section className="border-y border-border bg-[#0B1D2A]">
      <div className="mx-auto grid max-w-[1480px] md:grid-cols-2 lg:grid-cols-4">
        {items.map((item) => (
          <div key={item.value} className="border-b border-border px-8 py-10 md:border-r lg:border-b-0">
            <p className="font-serif text-2xl leading-tight text-foreground">{item.value}</p>
